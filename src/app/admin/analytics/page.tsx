                    ...
                    <main className="flex-1 ml-64 pt-16">
                        <div className="p-8">
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-sm">
                                    <div className="text-2xl font-bold text-orange-600">{totalFeedback}</div>
                            ...
                            <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
                                ...
                                <div className="bg-white p-6 rounded-lg shadow-sm">
                                    <h2 className="text-lg font-semibold mb-4">Most Popular Events</h2>
                                    <div className="space-y-3">
                                        {topEvents.map((event) => (
                            ...
                            <div className="mt-8 bg-white p-6 rounded-lg shadow-sm">
                                ...
                                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                                    <a href="/admin/events" className="block p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                                        <div className="font-medium">Manage Events</div>
                                        <div className="text-sm text-gray-500">Create, edit, and manage events</div>
                                    </a>
                                    ...
                                    <a href="/admin/registrations" className="block p-4 border border-gray-200 rounded-lg hover:bg-gray-50">
                                        <div className="font-medium">View Registrations</div>
                                        <div className="text-sm text-gray-500">Monitor event registrations</div>
                                    </a>
                                </div>
                            </div>
                        </div>
